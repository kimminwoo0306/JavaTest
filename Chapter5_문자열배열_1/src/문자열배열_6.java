...
public class 문자열배열_6 {
	...
	public static void main(String[] args) {
		...
		String[] guest_address={"헤이스 하우스2","큐브 게스트하우스","토다기","아리하우스","소소하우스","소담스테이","드림하우스2","돌마","연우하우스","샤샤하우스","게스트하우스 미야","다산하우스","하우스 홍시","Jeong's family","힐링한옥 채효당","지유","홍대스타일 게스트하우스","북촌마루 한옥 게스트하우스","써울스테이","Janet's House","연당(緣堂)","바닐라 3 스위트","스페이스 모다","화웬하우스(huayuan house1)","Greenery House(그리너리 하우스)","담소정","비빔밥게스트하우스","청향재","웨이브하우스","메종 드 웨이브.1","메종 드 웨이브.2","하노크 북촌","메종 드 웨이브.3","무위(無爲)","심산재","한옥 201(Hanok 201)","미담","홍유가인","복합한옥공간 곳","덕선재","서울삼촌","민규당 바이 버틀러:리","버틀러:리","지월장(指月藏)","게스트하우스 더힐2","예하도예 게스트하우스(YEHADOYE guesthouse)","알(R)게스트하우스_2(알게호)","에밀(Emile)","연당(緣堂)","바닐라 3 스위트","스페이스 모다","화웬하우스(huayuan house1)","Greenery House(그리너리 하우스)","서울 낙산 스테이(Seoul Naksan stay)","쯔요시노이에(tuyosinoie)","경복궁 서촌 크리스천 홈(Christian Home)","스페이스 휴(Space Hue)","USB하우스","어반 엑시트(URBAN EXIT)","종로한옥 궁 게스트하우스","만희재","시은재","은화당","CASA CIELO","LikeU","필프리 하우스","Jenny House","준 하우스","파크애비뉴2","27번가 게스트하우스","한옥스테이 언니집","퀸 하우스","LOFT 43 AMAZING HOUSE","에이프릴문 하우스","모던금자","엘하우스(L House)","한옥 포지티브스","풍경","소우주","석이한옥","서울이야기 한옥","다온 게스트하우스","한소","오케이 게스트하우스","지미집1","홈브릭(Brick House B)","한미장","웰컴게스트하우스","오-늘 스테이","Joy house","다자연 한옥게스트하우스","오 마이 게스트하우스","마루지 게스트하우스","Brick House","삼청동 코리아 게스트하우스","Hi, 동대문 한옥게스트하우스","알하우스","만두 게스트하우스","앨리스","어반우드","헤이스 하우스2","헤이스 하우스1","원 하우스","River Side","락고재","둥글하우스","그린홈스테이","더서울하우스","알 게스트하우스","큐브 게스트하우스","토다기","아리하우스","소소하우스","타임트래블러 릴렉스","코지룸","캄앤제이(Calm&Jay)","양재블루","롱램","Photo Park(포토박)","빅 존스 플레이스","데스파시토","종로하루","아름다운 황토집","리재","도토리집","와이이공이(Y202)","시월","(주)이리루","피스비(PIS-B)","락고재 북촌빈관","스위트룸","동주르 하우스","인우하우스","학민재","몽키하우스","스테이. 노멀띵스","코리게스트하우스","통인 1939","게스트하우스 몽자","개운산집","다다홈","서형가","라온 하우스 연남","공심가","이브","아늑공간","맨션 케렌시아","베르디게스트하우스(VERDI GUESTHOUSE)","몬데이크래커 홍대","홍대 애비뉴","지미집2","24게스트하우스 경희대점","서울 성북 홈스테이","라온 하우스 홍대","엠마 게스트하우스","121북촌","쥘리앵","미로 게스트하우스","세신버팔로","가회한옥체험관","지금(ZIKM)","민규당 바이 버틀러:리","버틀러:리","지월장(指月藏)","게스트하우스 더힐2","예하도예 게스트하우스(YEHADOYE guesthouse)","알(R)게스트하우스_2(알게호)","에밀(Emile)","소담스테이","드림하우스2","돌마","연우하우스","샤샤하우스","게스트하우스 미야","다산하우스","하우스 홍시","Jeong's family","힐링한옥 채효당","지유","홍대스타일 게스트하우스","북촌마루 한옥 게스트하우스","써울스테이","Janet's House","깨끗하고 아늑한 집(Clean Cosy House)","정연재","응정헌","누하당","효자스테이","쿤하우스(Koon house)","예본의 집","아트하우스","서촌게스트하우스","더 어반 게스트하우스","하우스앤가든(House & Gaden)","린다픽","코지한옥","루민 북촌","Aron house","Y's house","Brick House","삼청동 코리아 게스트하우스","Hi, 동대문 한옥게스트하우스","알하우스","만두 게스트하우스","앨리스","어반우드"};
		...
		// 총 페이지 구하기
	     ...
	     // 1page => 0, 2page=> 10, 3page =>20 ==> 배열의 인덱스 시작 번호(출력) ==> 앞은 스킵
	        ...
	        for(int i=0;i<guest.length;i++)
	        {
	        	...
	        	{
	        		System.out.println((i+1)+"."+guest[i]+"-----"+guest_address[i]);
	        		j++;
	        	}
	        }
	        System.out.println("====================================");
