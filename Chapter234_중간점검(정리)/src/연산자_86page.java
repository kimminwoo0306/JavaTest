 ...
 *                       || : 범위를 벗어나는 경우 (에러)
 *                      ---- 병렬 연산자 ==> (조건) || (조건) 둘중에 1개 이상 true면 true
 *                                        ------   ------
 ...
 *                          +=, -=, *= (복합 대입 연산자) : 합, 차, 곱을 구할때(누적), 제어문 증감을 많이 설정할 때
 *                          int a=10;
 *                          a+=2;   ===> a=a+2;
 *                          -> 10+2 = 12
 *                          a-=2;   ===> a=a-2;
 ...
 *                          a*=2;   ===> a=a*2;
 *                          -> 10*2 = 20
 *         삼항연산자 (피연산자 3개) ==> if~else ==> 소스를 줄일경우 (웹) => 가끔 등장
 *            (조건)?값1:값2
 *            ----- true => 값1
 *                 false => 값2
...
public class 연산자_86page {
	...
	//	int b3=b1+b2;
		int a=10;
		 // a라는 메모리에 10을 대입 (X) ,, 10을 a 메모리에 대입
