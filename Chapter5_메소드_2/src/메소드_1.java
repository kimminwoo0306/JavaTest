 ...
 *                  2) 메소드
 *                  =========================== += 클래스 (객체지향)
 *               1. 메소드 : 특정작업을 수행하는 일련의 명령문 모아서 관리
 *                         ------- 한가지 기능 (로그인 기능, 목록 출력 기능, 상세보기 기능...)
 *                         데이터 저장 : 변수, 배열
 *                         명령문 (CPU) : 메소드 ==> 명령
 *                         예)
 *                         	{
 ...
 *                2. 사용하는 이유
 *                   => 재사용
 *                   => 가독성(소스를 관련된 내용으로 나눈다) => 문장의 단락을 나눠서 처리하는 것과 같다.(구조적프로그램)
 *                   => 중복코드 제거
 *                   
 *                3. 메소드 구조
 ...
 *                       ------ 생략할 수 있다. (리턴형이 void일때) => 자체에서 결과값 출력
 *                    }
 ...
 *                              	==> 호출 : add(10,20,30)
 *                                  ==> 메소드는 같은 이름으로 만들 수 있다. (매개변수의 갯수나 데이터형이 다르면 된다)
 *                                      오버로딩
 *                                      println, print, ****printf()
 *                                  ==> printf("%d",10)
 *                                  ==> printf("%d%d",10,20) ==> 가변 매개변수
 *                                  	String...arg
 ...
 *                       double Math.random()
 *                   --------------------
 *                       X           O   ==> 리턴형이 없는 경우에는 반드시 void를 써야함 => 메소드 자체에서 처리
