 ...
 *     문자열을 저장하는 데이터형
 *     --------------------  '' (char) , ""(String)
 *                           문자 1개      문자 여러개 를 동시에 저장(char[]=> 쉽게 다루기 위해서 클래스)
...
public class 문자열정리 {
	...
	public static void main(String[] args) {
		...
		{
			System.out.println("시작하는 문자열");
		}
		else
		{
			System.out.println("시작하는 문자열 아님");
		}
		System.out.println("=============================");
		if(name.endsWith("홍")) // 포함시 true
		{
			System.out.println("끝나는 문자열");
		}
		else
		{
			System.out.println("끝나는 문자열 아님");
		}
	}
