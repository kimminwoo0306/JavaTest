 ...
 *                           => forEach : 배열의 데이터 출력하는 경우에 주로 사용
 * 
 *          변수 : 기본형 (한개 저장)
 *          배열
 *          클래스
 *          ---------------------- 1. 초기화(초기화가 안된 상태에서는 오류 발생)
 *              => 변수
 *                -----
 *                  = 지역변수 (메소드 안에 선언되는 변수) ==> 메소드에서 사용이 가능 {}가 종료되면 자동으로 사라지는 변수
