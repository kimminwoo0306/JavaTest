 ...
 *                    =------------------------------------> 객체지향 프로그램
 *         2. 최적화 : 실행속도가 빠르게 만든다
 *                    웹에서 최적화 (데이터 전송속도와 화면 출력 속도가 빠름)
 *                                               ------------react, vue
 *         3. 견고성 : 에러에 대응할 수 있는 프로그램 => 예외처리
 *       ==> 예외처리 방법
 *        - 예외처리 => 소스가 변경되는 것은 아니다, 복구해서 실행해 주는것은 아니다, 에러부분을 잘라내기
 *                    -------------1
 *                    -------------2
 *                    ====================정상수행
 *                    -------------3 ==> 에러
 ...
 *                      {
 *                      }
 *                    사용자 정의 => 지원하지 않는 것을 만든다 (자바 예외처리는 거의  대부분 있다)
 */
public class 예외처리정리 {
