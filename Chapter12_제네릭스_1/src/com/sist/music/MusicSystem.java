...
public class MusicSystem {
	private static ArrayList<Music> list=new ArrayList<Music>(); // 200개저장
	/*
	 *   초기화
	 *   ----
	 ...
	 */
	// 데이터 수집
	// 클래스 영역에서는 구현을 할 수 없다 => 선언만 가능 => 연산처리, 제어문처리, 예외처리 불가
	/*
	 *  <div>
	 *  	<div class="a">
