 ...
 *                ----        ---------
 *         *** 자바에서 사용하는 모든 문자열은 인덱스번호가 0부터 시작한다
 *         String s="0123456789";
 *         s.charAt(3) ==> '3'
 *         String s="ABCDEFG";
 *                   0123456
 ...
 *   **   5) equalsIgnoreCase : 문자열이 같은 경우 (대소문자 구분없이)
...
public class 라이브러리_1 {
	...
	public static void main(String[] args) {
		...
		// charAt : public char charAt(int index) : 지정된 위치의 문자를 읽어 올때 사용
	//	String s="Hello Java";
		//        0123456789
	//	char c=s.charAt(4);
	//	System.out.println("c="+c);
		// length() : public int length() => 문자의 갯수를 읽어온다 (영문, 한글동일)
		// length() ==> 화면 UI할때 글자수 확인, 비밀번호 검사
	/*	String e="ABC";
		String h="홍길동";
