 ...
 *     java.lang 주요 클래스
 *     ------------------
 *     1. Object : 모든 클래스의 상위 클래스 => 라이브러리 / 사용자 ==> 모든 클래스가 Object로부터 상속을 받는다
 ...
 *                                     
 *     
 *     1) Object : 모든 클래스는 Object로부터 상속을 받는다 (Object가 가지고 있는 모든기능을 사용할 수 있다)
 ...
 *                                                     형변환
 *      2) Object의 주요 메소드
 *  ***       1. 복제 기능 => 같은 값을 가진 메모리를 새롭게 만들어 준다 (스프링 : prototype)
 *            protected Object clone();
 *                      ------  ------
 *  ***       2. 객체를 문자열화
 *            public String toString(); ==> 가장 많이 오버라이딩
 *  ***       3. 소멸자 : 객체 메모리 제거
 *            protected void finalize(); ==> 메소드 소멸이 될때 자동 호출
...
class Main{
	...
	{
		this.a=a;
		System.out.println("Main클래스 메모리 할당..");
	}
	public void display()
	{
