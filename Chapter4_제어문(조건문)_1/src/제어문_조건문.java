 ...
 *                       
 *                       점수를 입력받아서 총점, 평균
 *                       kor => if(kor>=0 && kor<=100) ==> 처리가 어려운 부분이 있다.(예외처리)
 *                       => 항상 견고한 프로그램
 *            = 선택 조건문 (가장 많이 사용) => 줄이려면 삼항연산자
 *               형식)
 *                      if(조건)
 *                      {
 *                      	조건이 true일때 수행하는 문장
 ...
 *            = 다중 조건문
 */
// 사용자로부터 정수를 받아서 홀수인지 짝수인지 확인하는 프로그램
...
public class 제어문_조건문 {
	...
	public static void main(String[] args) {
		...
		Scanner scan=new Scanner(System.in); //new(클래스를 메모리에 저장, System.in=>키보드 입력값 받을때)
