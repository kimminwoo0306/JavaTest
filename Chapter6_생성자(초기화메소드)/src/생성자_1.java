...
public class 생성자_1 {
	 ...
	 *     -----
	 *       |
	 *     메모리(heap)에 a라는 객체를 생성
	 *     --------------------------
	 *     a에 지정된 메모리 주소를 넘겨줌
	 */
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		생성자_1 a=new 생성자_1();  // 모든 클래스의 객체를 생성 = this (생성된 주소값 저장)
