...
public class MainClass_실행순서 {
	...
	public static void main(String[] args) {
		...
		{
			String str= " 10";
			System.out.println(Integer.parseInt(str.trim()));  // parseInt() 문자열을 정수형으로 변경할 때 사용하는 메소드
		...
		{
			 // 객체, 클래스의 주소값이 없는 경우
			System.out.println("객체의 주소가 없습니다");
		...
		}catch(RuntimeException ex)
		{
			...
			System.out.println("위에 등록된 예외 외의 다른 모든 에러를 잡습니다.");
