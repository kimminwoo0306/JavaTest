 ...
 *                 
 *          -----------------------------------------
 *          컴파일 에러 : 컴파일시에 에러 (문법 에러) javac
 *          런타임 에러 : 실행시에 에러 java
 *          논리적 에러 : 실행은 된다. 프로그램 제작과 다르게 동작
 *          -----------------------------------------
 ...
 *             Exception : 파일명이 틀리다, IP가 틀리다, 웹사이트주소가 틀리다... SQL문장을 잘못 썻다
 *                           Object
 *                              |
 ...
 *            4. 사용자 정의 예외처리
 *            
 *            1. 직접처리 (예외 복구) : 웹, 데이터베이스는 CheckException (무조건 예외처리를 해야된다)
 ...
 *               }catch(예외처리 종류)
 *               {
 *                    에러가 발생했을때 처리하는 영역 => 에러 확인 => 예상되는 예외처리 => catch(여러번 사용이 가능)
 *               }
 *               finally
 *               {
 *                    try, catch 수행 상관없이 무조건 수행하는 문장 => 생략이 가능
 *                    에러발생, 정상수행 상관없이 무조건 수행하는 문장이 존재
 *                    -------------------------------------------
 *                    1) 파일 닫기
 *                    2) 오라클 닫기 => test(XE)
 *                    3) 서버 닫기
 ...
 *           1. 고민 : 예상되는 에러
 *           예)
 *              두개의 정수를 문자열로 받아서 정수 배열에 저장, 저장된 데이터를 나누기를 하는 프로그램 제작
 *                                      ------ 배열 인덱스           ------0으로 나누기
 *                                      문자열=>정수
 *           2. 고민 : 예외처리의 위치
 *              
