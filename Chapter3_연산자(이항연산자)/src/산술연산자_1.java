 ...
 *             *** int 이하( byte, short, char) 는 연산처리시에 결과값은 int
 *               예)
 *                  byte + byte = int
 *                  char + char = int
 *                  byte + char = int
 ...
 *                 
 *               3. % 나누고 나머지 ----> 화폐매수 구하기, 배수, 달력(요일 구하기), 윤년체크
 *                 10%3 ==> 1
...
public class 산술연산자_1 {
	...
	public static void main(String[] args) {
		...
		a=scan.nextInt(); // 입력된 정수값을 가지고 온다 -> a 메모리에 저장
		b=scan.nextInt(); // 입력된 정수값을 가지고 온다 -> b 메모리에 저장
		//출력
